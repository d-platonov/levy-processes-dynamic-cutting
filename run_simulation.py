...
if __name__ == '__main__':
    ...
    n_trajectories = 1000
    params = {
        't': 1, 'h': 0.05, 'eps': 0.01, 'n_grid': 100, 'z_0': 0, 'seed': 42,
        'approximation_type': ApproximationType.CUT_2
    }
    ...
    alpha_stable_results = monte_carlo.estimate_alpha_stable_moments(
        params, n_simulations, n_trajectories, p, alpha_values
    )
    print(f"Alpha-stable moments: \n{alpha_stable_results}")

    # Tempered-stable statistics 1)
    ...
    tempered_stable_results_1 = monte_carlo.estimate_tempered_stable_cumulants(
        params, alpha_plus, beta_plus, alpha_minus, beta_minus, n_simulations, n_trajectories, seed=12
    )
